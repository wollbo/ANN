...
lambda = 10e-4; % ger inte bättre prestanda än lambda = 0 : kolla om weight decay är rätt


alpha = 0.9;
eta = 10e-4; % på gränsen, konvergerar ej för eta = 10e-3. learning rate verkar vara avgörande faktor för prestanda
T = 20; % minimal amount of epochs

%% Tre lager
eta = 3*10e-4; % på gränsen, konvergerar ej för eta = 10e-3. learning rate verkar vara avgörande faktor för prestanda
for m = 1:100
